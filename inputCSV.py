...
for row in csv_data:
   print(row)
   cursor.execute('INSERT INTO ac_grade_input(term, program_code, program_name, program_version, course_level, course_year, '+
                   'student_num, student_fname, student_lname, student_email, student_level, prof_fname, prof_lname, course_num, '+
                   'course_title, letter_grade, percent, fcomment, rcomment) VALUES(%s, %s, %s, "2019-2020", '+
                   '%s, "2020", %s, %s, %s, "", "4", %s, %s, '+
                   '%s, %s, %s, %s, %s, %s)', row)
